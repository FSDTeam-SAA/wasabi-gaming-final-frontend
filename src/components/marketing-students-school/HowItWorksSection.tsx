      ...
      <div className="container flex flex-col  items-center lg:gap-60  lg:flex-row ">
        ...
        <div className="lg:py-20 py-10 max-w-4xl text-center lg:text-left">
          ...
          <Link href="/dashboard/cv-builder">
            <Button className="py-3 px-12 mt-6 rounded-full bg-[#FFFF00] hover:bg-[#FFFF00]/80 text-[#282828] font-bold shadow-lg hover:shadow-xl hover:scale-105 hover:-translate-y-1 transition-all duration-300">
              Create Your Resume
            </Button>
          </Link>
        </div>
