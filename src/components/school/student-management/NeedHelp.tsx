                    ...
                    <div className="space-y-10 text-left">
                        <section>
                            <h3 className="text-xl font-bold mb-3 flex items-center gap-3">
                                <span className="w-8 h-8 bg-black text-yellow-400 rounded-full flex items-center justify-center text-sm shrink-0">1</span>
                                Website Overview
                            </h3>
                        ...
                        <section>
                            <h3 className="text-xl font-bold mb-3 flex items-center gap-3">
                                <span className="w-8 h-8 bg-black text-yellow-400 rounded-full flex items-center justify-center text-sm shrink-0">2</span>
                                Website Purpose
                            </h3>
                            <p className="text-gray-600 leading-relaxed text-base">
                                ...
                                educational institutions in bridgeing the gap between education and career.
                            </p>
                        </section>

                        <section>
                            <h3 className="text-xl font-bold mb-3 flex items-center gap-3">
                                <span className="w-8 h-8 bg-black text-yellow-400 rounded-full flex items-center justify-center text-sm shrink-0">3</span>
                                Target Users
                            </h3>
                            <p className="text-gray-600 leading-relaxed text-base">
                                The platform caters primarily to two types of users — Students and
                                School Administrators. Each has dedicated features tailored to their needs.
                            </p>
                        </section>

                        <section>
                            <h3 className="text-xl font-bold mb-3 flex items-center gap-3">
                                <span className="w-8 h-8 bg-black text-yellow-400 rounded-full flex items-center justify-center text-sm shrink-0">4</span>
                                Functionality Guide
                            </h3>
                            <p className="text-gray-600 leading-relaxed text-base">
                        ...
                        <div className="bg-yellow-50 p-6 rounded-2xl border border-yellow-200 text-center">
                            <p className="text-yellow-800 font-bold mb-2">Need More Details?</p>
                            <p className="text-yellow-700 text-sm">Download the full PDF version from the Resources section in your dashboard.</p>
                        </div>
                    </div>
                </DialogContent>
            </Dialog>
