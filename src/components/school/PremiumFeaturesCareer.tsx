...
const PremiumFeaturesCareer = () => {
    ...
    const buttons = [
        { name: 'Student Tracking', image: '/schoolProject1.png' },
         { name: 'Student Profiles', image: '/images/student-profile.png' },
        { name: 'Events', image: '/events.jpeg' },
         { name: 'Student Premium Features', image: '/images/student-premium-features.png' },
            ...
            <div className="relative z-10 pb-12 px-6">
                ...
                <div className="flex overflow-hidden mt-10 items-center justify-center">
                    <Image
                        ...
                        height={900}
                        quality={100}
                        className="object-contain w-full h-auto md:h-[600px] lg:h-[751px] rounded-lg transition-all duration-300"
                    />
                </div>
            </div>
        </div>
...
export default PremiumFeaturesCareer
