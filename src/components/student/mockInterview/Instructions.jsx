export default function Instructions({ onProceed }) {
  return (
    <section className="min-h-screen bg-white py-12 md:py-20 px-4 md:px-8 lg:px-16 poppins">
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="w-full max-w-3xl bg-white border border-[#d9d9d9] rounded-lg p-8 md:p-12 shadow-sm text-[#4A5565]">
          ...
          {/* Instructions Title */}
          {/* <p className="font-semibold text-[#303030] mb-4">
          ...
          {/* Equipment Title */}
          <p className="mb-4">Essential Equipment & Environment Check:</p>
        ...
        <div className="flex justify-center mt-10">
          <button
            onClick={onProceed}
            className="w-[227px] h-10 bg-[#ffff00] rounded-[14px] flex items-center justify-center font-bold text-[#1e1e1e] text-base leading-[26px] hover:bg-[#e6e600] transition-colors"
          >
            Proceed
          </button>
        </div>
