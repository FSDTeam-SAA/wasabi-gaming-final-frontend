    ...
    <div className="min-h-screen bg-white pb-20">
      ...
      <div className="pb-8">
        ...
        <div className="container mx-auto pt-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm  relative border-2 border-[#0000001A]">
            ...
            <div className="mb-6 px-[32px]">
              ...
              <p className="text-xl text-[#4A5565] mb-6">
                {firmData.firmType || firmData.firmType || "Professional Legal Services"}
              </p>
          ...
          {/* ✅ TAB CONTENT now under the SAME container */}
          <div className="py-12 px-5 border border-[#0000001A] rounded-2xl mt-8">
            <div className="">
                ...
                {activeTab === "overview" && (
                  <>
                    ...
                    <div className=" shadow-md rounded-[12px] pt-8">
                      <div className="flex items-start gap-4">
                        <div className="w-10 h-10 bg-gray-50 rounded-lg flex items-center justify-center flex-shrink-0 pl-2">
                          <Image src="/lawicon.png" width={1000} height={1000} alt="Recent Annual Revenue" className="w-6 h-6 object-cover" />
                        </div>
                    ...
                    <div className=" shadow-md rounded-[12px] pt-8">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <h2 className="text-lg font-normal text-[#1E1E1E] mb-2">
                            {firmData?.recentWorks?.title || "Recent Awards"}
                          </h2>
                          <h3 className="text-base font-normal text-[#4A5565] mb-3">
                    ...
                    <div className=" shadow-md rounded-[12px] pt-8">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <h2 className="text-lg font-normal text-[#1E1E1E] mb-2">
                            {firmData?.technologyInitiatives?.title || "Recent Awards"}
                          </h2>
                          <h3 className="text-base font-normal text-[#4A5565] mb-3">
                    ...
                    <div className=" shadow-md rounded-[12px] pt-8">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <h2 className="text-lg font-normal text-[#1E1E1E] mb-2">
                            {firmData?.diversityEquityAndInclusion?.title || "Recent Awards"}
                          </h2>
                          <h3 className="text-base font-normal text-[#4A5565] mb-3">
                    ...
                    <div className=" shadow-md rounded-[12px] pt-8">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <h2 className="text-lg font-normal text-[#1E1E1E] mb-2">
                            {firmData?.CSRAndProBono?.title || "Recent Awards"}
                          </h2>
                          <h3 className="text-base font-normal text-[#4A5565] mb-3">
