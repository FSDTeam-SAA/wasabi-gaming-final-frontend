...
export default function AppliedJobs() {
    ...
    const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY5NzA1Y2I1NzI0OTlhOWZiOWFiNjg1YSIsInJvbGUiOiJzdHVkZW50IiwiZW1haWwiOiJzdHVkZW50QGdtYWlsLmNvbSIsImlhdCI6MTc2OTI1MDQ4OSwiZXhwIjoxNzY5ODU1Mjg5fQ.n_EkQqC2vZ_jJwl4uDag7uSUIZo_1WWVdssMvOdkJPI";
